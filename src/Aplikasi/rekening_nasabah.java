...
DefaultTableModel kolom=new DefaultTableModel(null,judul);
    ...
    {
    con.setkoneksi();
    con.rs=con.st.executeQuery("select simpan.no_ang,simpan.username,simpan.tanggal,simpan.ket,(simpan.saldo + SUM(IFNull(debet,0))) sald from simpan left join detail_simpanan \n" +
"on detail_simpanan.no_ang = simpan.no_ang GROUP BY simpan.no_ang");
